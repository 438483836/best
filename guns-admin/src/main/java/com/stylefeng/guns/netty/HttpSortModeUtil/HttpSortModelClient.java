 ...
 * 分拣模式获取
 */
public class HttpSortModelClient {

    private static Logger logger = LoggerFactory.getLogger(HttpSortModelClient.class);
    //static
    ...
    static {
        try {
            uri=new URI(Supply2ServerConst.bestExpressSortModeURL);
    ...
    public HttpSortModelClient(ApplicationContext applicationContext){
                ...
                .handler(new ChannelInitializer<SocketChannel>() {
                    ...
                    public void initChannel(SocketChannel ch) throws Exception {
                        ch.pipeline().addLast(//
                                ...
                                //修改成时间的接收
                                new HttpSortModeClientInitializer(sslCtx));
                    }
                });
    }
    ...
    public void sendSyncImpl( String msg) throws InterruptedException {
        ...
        HttpRequest request = new DefaultFullHttpRequest(
                HttpVersion.HTTP_1_1, HttpMethod.GET, uri.getRawPath().concat("?pipeline=")+msg );
        ...
        channel.writeAndFlush(request).addListener(new ChannelFutureListener() {
            ...
            public void operationComplete(ChannelFuture f) throws Exception {
                if (f.isSuccess()) {
                    ...
                    logger.info("Send Sort-Mode Data to BestExpress Request Success");
                } else {
                    logger.info("Send Sort-Mode Data to BestExpress Request Failed");
                    HttpSortModeService.bestSortModeRequestQueue.put(failStr);
